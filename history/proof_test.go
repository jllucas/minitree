...
func TestVerifyMembershipProof(t *testing.T) {
	...
	testsOK := map[string]struct {
		...
		"Verify mem. proof index 2 verion 2": {2,
			membershipProofv2,
			common.Hash{0x5a, 0x81, 0x1e, 0xdb, 0xa, 0x1f, 0xe9, 0xdb, 0xae, 0x63, 0x15, 0x46, 0xf5, 0x39, 0x1f, 0x8c, 0x31, 0x9c, 0x31, 0x4e, 0xb2, 0x4f, 0x54, 0x11, 0x82, 0xa7, 0xd, 0x13, 0xa1, 0x27, 0x44, 0xc9},
			common.Hash{0xa9, 0x53, 0xf0, 0x9a, 0x1b, 0x6b, 0x67, 0x25, 0xb8, 0x19, 0x56, 0xe9, 0xad, 0xb, 0x1e, 0xb4, 0x9e, 0x3a, 0xd4, 0x0, 0x4, 0xc0, 0x43, 0x7, 0xef, 0x8a, 0xf6, 0x24, 0x6a, 0x5, 0x41, 0x16},
		},
		"Verify mem. proof index 2 verion 3": {2,
			membershipProofv3,
			common.Hash{0x51, 0x3, 0x81, 0x37, 0x79, 0x81, 0x1e, 0x71, 0x39, 0xcb, 0xc7, 0x2d, 0xc6, 0x1e, 0x37, 0x71, 0xe3, 0x54, 0x24, 0x94, 0xd5, 0xe9, 0xe1, 0xc8, 0x80, 0xd7, 0x22, 0xfc, 0x6c, 0x2, 0xb1, 0x25},
			common.Hash{0xa9, 0x53, 0xf0, 0x9a, 0x1b, 0x6b, 0x67, 0x25, 0xb8, 0x19, 0x56, 0xe9, 0xad, 0xb, 0x1e, 0xb4, 0x9e, 0x3a, 0xd4, 0x0, 0x4, 0xc0, 0x43, 0x7, 0xef, 0x8a, 0xf6, 0x24, 0x6a, 0x5, 0x41, 0x16},
		},
	}
	...
	for testname, test := range testsOK {
		...
		assert.True(t, isMember, "Wrong result in test: %s", testname)
	}
...
func TestVerifyIncrementalProof(t *testing.T) {
	...
	testsOK := map[string]struct {
		commitmentI, commitmentJ common.Hash
		indexI, indexJ           int
		incrementalProof         HistoryTree
	}{
		"Verify inc. proof between 2 and 4": {common.Hash{0x5a, 0x81, 0x1e, 0xdb, 0xa, 0x1f, 0xe9, 0xdb, 0xae, 0x63, 0x15, 0x46, 0xf5, 0x39, 0x1f, 0x8c, 0x31, 0x9c, 0x31, 0x4e, 0xb2, 0x4f, 0x54, 0x11, 0x82, 0xa7, 0xd, 0x13, 0xa1, 0x27, 0x44, 0xc9},
			common.Hash{0x5, 0x20, 0x71, 0x91, 0x8, 0x93, 0x3d, 0x29, 0x47, 0x41, 0x90, 0xff, 0x37, 0x77, 0x4a, 0xfa, 0x8, 0xe5, 0x1f, 0x8a, 0x73, 0x91, 0xeb, 0x1b, 0xaa, 0xf5, 0x0, 0x51, 0x27, 0xf6, 0xc6, 0x62},
			2,
			4,
			incrementalProofv4,
		},
	...
	for testname, test := range testsOK {
		...
		assert.True(t, notTampered, "Wrong result in test: %s", testname)
	}
}
